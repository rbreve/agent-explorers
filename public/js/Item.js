...
export const ITEM_DEFS = {
  ...
  axe:         { icon: '/images/axe.png',           size: [22,22], z: 1.5, autoPickup: false,  grabbable: true, meleeDamage: 8 },
  hammer:      { icon: '/images/hammer.png',        size: [22,22], z: 1.5, autoPickup: false,  grabbable: true, meleeDamage: 5 },
  ...
  animal_trap: { icon: '/images/animaltrap.png',  size: [22,22], z: 0.8, autoPickup: false, grabbable: false, opacity: 0.4, radius: 12 },
